            ...
            <form action="/bobotkriteria/create" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="bobot_kepribadian"
                        ...
                        placeholder="Bobot Kepribadian" required value="{{ old('bobot_kepribadian') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="bobot_ipk" class="form-control @error('bobot_ipk') is-invalid @enderror"
                        id="bobot_ipk" placeholder="Bobot IPK" required value="{{ old('bobot_ipk') }}">
                    @error('bobot_ipk')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="bobot_prestasi"
                        ...
                        placeholder="Bobot Prestasi" required value="{{ old('bobot_prestasi') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="bobot_penghasilan"
                        ...
                        placeholder="Bobot Penghasilan" required value="{{ old('bobot_penghasilan') }}">
